    ...
    return (
        <div className="mx-auto my-16 w-full bg-white rounded-lg shadow dark:border sm:max-w-md xl:p-0 dark:border-gray-300">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <p>
                    You want to solve a problem? <Link href="/register/customer" className="text-amber-500 hover:underline dark:text-primary-500">Create an account</Link> and book a service.
                </p>
